--# world database with: name, continent, area, population, gdp
...
--# 2. Show the countries in Europe with a per captia GDP greater than 'United Kingdom'
SELECT name
FROM world
...
WHERE continent 
   ...
   ORDER BY name
         IN ('Argentina', 'Australia') DESC, name
